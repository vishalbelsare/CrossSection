...
| Recomm_ShortInterest*     | ✅         | ❌ (77.28%) | ❌ (+97.0%)  | ✅ (0.1%)     | ❌ (2.0E+00)   | ❌ (-0.54)  |
| IO_ShortInterest*         | ✅         | ❌ (40.84%) | ❌ (+95.7%)  | ✅ (0.0%)     | ✅ (7.9E-08)   | ✅ (-0.10)  |
...
**Overall**: 149/212 available predictors passed validation
  - Natural passes: 135
...
- Test 2 - NumRows check: ❌ FAILED (Python has +95.72% rows vs Stata)
- Test 3 - Precision1 check: ✅ PASSED
- Test 4 - Precision2 check: ✅ PASSED
- Test 5 - T-stat check: NA
...
**Precision2**: 100th percentile diff = 7.92e-08 (tolerance: < 1.00e-01)
...
| mean       |        85.8102 |        85.8102 |      -1.66e-08 |      -1.32e-10 |
| std        |       126.3390 |       126.3390 |       3.14e-06 |       2.49e-08 |
| min        |         0.0000 |         0.0000 |      -1.00e-05 |      -7.92e-08 |
| 25%        |        54.0965 |        54.0965 |         0.0000 |         0.0000 |
| 50%        |        94.0680 |        94.0680 |         0.0000 |         0.0000 |
| 75%        |       115.8300 |       115.8300 |         0.0000 |         0.0000 |
| max        |      7896.3999 |      7896.4000 |       1.00e-04 |       7.92e-07 |
...
| Coefficient |     Estimate |    Std Error | t-statistic |   p-value |
|-------------|--------------|--------------|-------------|----------|
| Intercept   |    -1.19e-06 |     4.39e-08 |    -27.0448 |     0.000 |
| Slope       |       1.0000 |     2.87e-10 |    3.48e+09 |     0.000 |
...
**Feedback**:
- Num observations with std_diff >= TOL_DIFF_1: 0/5231 (0.000%)
...
**Test Results**:
- Test 1 - Superset check: ❌ FAILED (Python missing 26753 Stata observations)
- Test 2 - NumRows check: ❌ FAILED (Python has +97.03% rows vs Stata)
- Test 3 - Precision1 check: ✅ PASSED
- Test 4 - Precision2 check: ❌ FAILED
- Test 5 - T-stat check: NA
...
| Statistic  |          Stata |         Python |     Difference | Std Difference |
|------------|----------------|----------------|----------------|----------------|
| count      |      7866.0000 |      7866.0000 |      7866.0000 |      7866.0000 |
| mean       |         0.5782 |         0.5769 |        -0.0013 |        -0.0026 |
| std        |         0.4939 |         0.4941 |         0.0356 |         0.0722 |
| min        |         0.0000 |         0.0000 |        -1.0000 |        -2.0248 |
| 25%        |         0.0000 |         0.0000 |         0.0000 |         0.0000 |
| 50%        |         1.0000 |         1.0000 |         0.0000 |         0.0000 |
| 75%        |         1.0000 |         1.0000 |         0.0000 |         0.0000 |
| max        |         1.0000 |         1.0000 |         0.0000 |         0.0000 |
...
- **R-squared**: 0.9948
- **N observations**: 7,866

| Coefficient |     Estimate |    Std Error | t-statistic |   p-value |
|-------------|--------------|--------------|-------------|----------|
| Intercept   |    -5.38e-15 |     6.18e-04 |   -8.70e-12 |     1.000 |
| Slope       |       0.9978 |     8.13e-04 |   1226.9171 |     0.000 |
...
**Feedback**:
- Num observations with std_diff >= TOL_DIFF_1: 10/7866 (0.127%)
...
**Test Results**:
- Test 1 - Superset check: ✅ PASSED
- Test 2 - NumRows check: ❌ FAILED (Python has +94.65% rows vs Stata)
- Test 3 - Precision1 check: ❌ FAILED
- Test 4 - Precision2 check: ❌ FAILED
- Test 5 - T-stat check: NA
